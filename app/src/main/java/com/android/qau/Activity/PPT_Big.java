...
public class PPT_Big extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        im_forward.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (PPTNumber==pptSum){
                    Toast.makeText(PPT_Big.this, "这是最后一张了", Toast.LENGTH_SHORT).show();
                }else {
                    PPTNumber++;
        ...
        im_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (PPTNumber==1){
                    Toast.makeText(PPT_Big.this, "这是第一张了", Toast.LENGTH_SHORT).show();
                }else {
                    PPTNumber--;
                    im_forward.setBackgroundResource(getResources().getIdentifier(keys[thisNumber] + PPTNumber, "drawable", packageName));
                    tv_number.setText(PPTNumber+"/"+pptSum);
